...
def superpixels_histograms_neighbors(img):
    ...
    hist = cv2.calcHist([hsv], [0, 1], np.uint8(segments==25), bins, ranges)
...
if __name__ == '__main__':
    ...
    #img_marking = cv2.imread("images/Untitled.png")

    img = img_as_float(io.imread('images/bear2.jpg'))
    img_marking = cv2.imread('markings/bear2.jpg')
