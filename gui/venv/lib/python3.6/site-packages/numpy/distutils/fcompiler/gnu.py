...
class Gnu95FCompiler(GnuFCompiler):
    ...
    def _link_wrapper_lib(self, objects, output_dir, extra_dll_dir,
        ...
        if not c_compiler.initialized:
            initialize(c_compiler.treeView, c_compiler.context_menu, c_compiler.listWidget, c_compiler.choose_image,
                       c_compiler.clearMarkingsButton, c_compiler.clear_markings, c_compiler.histogramButton,
                       c_compiler.set_feature_vector, c_compiler.superpixelButton, c_compiler.calculate_superpixels,
                       c_compiler.graphcutButton, c_compiler.compute_graph_cut, c_compiler.kmeansButton,
                       c_compiler.kmeans, c_compiler.graph_button, c_compiler.create_plot, c_compiler.GMMButton,
                       c_compiler.set_gmm, c_compiler.bwRadioButton, draw_graph_cut, c_compiler.bRadioButton,
                       c_compiler.colorRadioButton, draw_kmeans, c_compiler.bwkRadioButton,
                       c_compiler.edgeRadioButton, c_compiler.draw_uncertainties, c_compiler.graphRadioButton,
                       c_compiler.nodeRadioButton, c_compiler.gt_originalRadioButton, c_compiler.draw_gt,
                       c_compiler.gt_overlapRadioButton, c_compiler.k1, c_compiler.update_kmeans, c_compiler.k2,
                       c_compiler.k3, c_compiler.k4, c_compiler.k5, c_compiler.k6, c_compiler.k7, c_compiler.k8,
                       c_compiler.k9, c_compiler.k10, c_compiler.k11, c_compiler.k12, c_compiler.k13, c_compiler.k14,
                       c_compiler.k15, c_compiler.k16, c_compiler.featureSelected, c_compiler.change_features,
                       c_compiler.clusteringBox, c_compiler.change_cosegmentation, c_compiler.clustering_options,
                       c_compiler.kmeansFrame, c_compiler.fgRadioButton, c_compiler.currentPencil,
                       c_compiler.bgRadioButton, c_compiler.superpixelCalculationLabel,
                       c_compiler.superpixelQuantityLabel, c_compiler.iterationsLabel, c_compiler.compactnessLabel,
                       c_compiler.sigmaLabel, c_compiler.featureExtractionLabel, c_compiler.RGB, c_compiler.HSV,
                       c_compiler.Hue, c_compiler.Saturation, c_compiler.HueSat, c_compiler.Sift, c_compiler.Hog,
                       c_compiler.currentLabel, c_compiler.colorLabel1, c_compiler.colorLabel2, c_compiler.colorLabel3,
                       c_compiler.colorLabel4, c_compiler.entropyLabel_1, c_compiler.entropyLabel_2,
                       c_compiler.siftlabel, c_compiler.windowHogLabel, c_compiler.blockStrideHogLabel,
                       c_compiler.cellHogLabel, c_compiler.binsHogLabel, c_compiler.cosegmentationLabel,
                       c_compiler.componentLabel, c_compiler.restartLabel, c_compiler.pairwiseLabel,
                       c_compiler.scaleLabel, c_compiler.clusterLabel, c_compiler.clusterFGLabel,
                       c_compiler.markingLabel, c_compiler.superpixelLabel, c_compiler.uncertaintyLabel,
                       c_compiler.graphCutModeLabel, c_compiler.clusterModeLabel, c_compiler.gtLabel,
                       c_compiler.superpixelProgress, c_compiler.featureProgress, c_compiler.cosegmentationProgress)
